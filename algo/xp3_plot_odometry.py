...
DATA = os.path.join(ROOT, "assets", "data_xp", "odometry")            # les CSV
OUT = os.path.join(ROOT, "assets", "plot_xp", "xp_odometry_plot.png")   # l'image du post
...
runs = {}
for path in sorted(glob.glob(os.path.join(DATA, "xp_motor*_odometry_log_*.csv"))):
