...
Magnitude = V & A describe how much, how much pressure (V), how much flow (A), at a given instant. <br>
Hertz (Hz) describe how fast something repeats/changes over time.
