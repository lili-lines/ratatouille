...
* **DC (Direct Current / Courant Continu):** The current flows in one single direction (from **+** to **-**). 
...
#### ☢️ 7. Star vs. Delta Connections (Étoile / Triangle)
These are methods used to connect three-phase electrical loads (like heavy industrial motors or specific brushless motors). 
🐭 While small stepper motors or DC brushed motors are more common in standard MicroMousses, understanding these configurations is key if you transition to advanced high-efficiency Brushless DC (BLDC) motors.

#### 🗺️ 8. PCB (Printed Circuit Board / Circuit Imprimé)
